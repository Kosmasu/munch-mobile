...
interface CartAPI {
  @GET("cart")
  fun fetchPaginate(@QueryMap parameters: Map<String, String>): Response<Paginate<List<Cart>>>

  @GET("cart")
  fun fetchUnpaginated(@QueryMap parameters: Map<String, String>): Response<List<Cart>>
