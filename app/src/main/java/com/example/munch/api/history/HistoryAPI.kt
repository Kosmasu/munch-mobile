...
interface HistoryAPI {
  @GET("log")
  suspend fun logPaginate(@QueryMap parameters: Map<String, String?>): Response<Result<Paginate<List<HistoryLog>>>>

  @GET("log")
  suspend fun logUnpaginated(@QueryMap parameters: Map<String, String?>): Response<Result<List<HistoryLog>>>

  @GET("historyMenu")
  suspend fun menuPaginate(@QueryMap parameters: Map<String, String?>): Response<Result<Paginate<List<HistoryMenu>>>>

  @GET("historyMenu")
  suspend fun menuUnpaginated(@QueryMap parameters: Map<String, String?>): Response<Result<List<HistoryMenu>>>

  @GET("historyTopup")
  suspend fun topUpPaginate(@QueryMap parameters: Map<String, String?>): Response<Result<Paginate<List<HistoryTopUp>>>>
