...
interface UserAPI {
  @GET("users")
  fun fetchPaginate(@QueryMap parameters: Map<String, String>): Response<Paginate<List<User>>>

  @GET("users")
  fun fetchUnpaginated(@QueryMap parameters: Map<String, String>): Response<List<User>>
